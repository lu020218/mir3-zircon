...
namespace Client.Controls
{
    public sealed class DXConfigWindow : DXWindow
    {
        ...
        public DXConfigWindow()
        {
            ...
            TitleLabel.Text = string.Format(CEnvir.Language.Configuration);
            HasFooter = true;
            ...
            GraphicsTab = new DXTab
            {
                Parent = TabControl,
                Border = true,
                TabButton = { Label = { Text = string.Format(CEnvir.Language.Graphics) } },
            };
            ...
            SoundTab = new DXTab
            {
                Parent = TabControl,
                Border = true,
                TabButton = { Label = { Text = string.Format(CEnvir.Language.Sound) } },
            };
            ...
            GameTab = new DXTab
            {
                Parent = TabControl,
                Border = true,
                TabButton = { Label = { Text = string.Format(CEnvir.Language.Game) } },
            };
            ...
            NetworkTab = new DXTab
            {
                Parent = TabControl,
                Border = true,
                TabButton = { Label = { Text = string.Format(CEnvir.Language.Network) } },
            };
            ...
            ColourTab = new DXTab
            {
                Parent = TabControl,
                Border = true,
                TabButton = { Label = { Text = string.Format(CEnvir.Language.Colours) }, Visible = false },
            };
            ...
            {
                Label = { Text = string.Format(CEnvir.Language.FullScreen) },
                Parent = GraphicsTab,
            ...
            {
                Text = string.Format(CEnvir.Language.GameSize),
                Outline = true,
                Parent = GraphicsTab,
            };
            ...
            {
                Label = { Text = string.Format(CEnvir.Language.VSync) },
                Parent = GraphicsTab,
            };
            ...
            {
                Label = { Text = string.Format(CEnvir.Language.LimitFPS) },
                Parent = GraphicsTab,
            };
            ...
            {
                Label = { Text = string.Format(CEnvir.Language.ClipMouse) },
                Parent = GraphicsTab,
            };
            ...
            {
                Label = { Text = string.Format(CEnvir.Language.DebugLabel) },
                Parent = GraphicsTab,
            };
            ...
            label = new DXLabel
            {
                Text = string.Format(CEnvir.Language.Language),
                Outline = true,
                Parent = GraphicsTab,
            };
            ...
            {
                Label = { Text = string.Format(CEnvir.Language.BackgroundSound) },
                Parent = SoundTab,
            ...
            label = new DXLabel
            {
                Text = string.Format(CEnvir.Language.SystemVolume),
                Outline = true,
                Parent = SoundTab,
            };
            label.Location = new Point(104 - label.Size.Width, 35);
            ...
            label = new DXLabel
            {
                Text = string.Format(CEnvir.Language.MusicVolume),
                Outline = true,
                Parent = SoundTab,
            };
            ...
            label = new DXLabel
            {
                Text = string.Format(CEnvir.Language.PlayerVolume),
                Outline = true,
                Parent = SoundTab,
            };
            ...
            label = new DXLabel
            {
                Text = string.Format(CEnvir.Language.MonsterVolume),
                Outline = true,
                Parent = SoundTab,
            };
            ...
            label = new DXLabel
            {
                Text = string.Format(CEnvir.Language.MagicVolume),
                Outline = true,
                Parent = SoundTab,
            };
            ...
            {
                Label = { Text = string.Format(CEnvir.Language.ItemName) },
                Parent = GameTab,
            };
            ...
            {
                Label = { Text = string.Format(CEnvir.Language.MonsterName) },
                Parent = GameTab,
            };
            ...
            {
                Label = { Text = string.Format(CEnvir.Language.PlayerName) },
                Parent = GameTab,
            };
            ...
            {
                Label = { Text = string.Format(CEnvir.Language.UserHealth) },
                Parent = GameTab,
            };
            ...
            {
                Label = { Text = string.Format(CEnvir.Language.MonsterHealth) },
                Parent = GameTab,
            };
            ...
            {
                Label = { Text = string.Format(CEnvir.Language.DamageNumbers) },
                Parent = GameTab,
            };
            ...
            {
                Label = { Text = string.Format(CEnvir.Language.EscapeCloseAll) },
                Parent = GameTab,
            };
            ...
            {
                Label = { Text = string.Format(CEnvir.Language.ShiftOpenChat) },
                Parent = GameTab,
                Hint = string.Format(CEnvir.Language.ShiftOpenChatHt)
            };
            ...
            {
                Label = { Text = string.Format(CEnvir.Language.RightClickDeTarget) },
                Parent = GameTab,
                Hint = string.Format(CEnvir.Language.RightClickDeTargetHt)
            };
            ...
            {
                Label = { Text = string.Format(CEnvir.Language.MonsterBoxVisible) },
                Parent = GameTab,
            };
            ...
            {
                Label = { Text = string.Format(CEnvir.Language.LogChat) },
                Parent = GameTab,
            };
            ...
            {
                Label = { Text = string.Format(CEnvir.Language.DrawEffects) },
                Parent = GameTab,
            };
            ...
            KeyBindButton = new DXButton
            {
                ...
                Label = { Text = string.Format(CEnvir.Language.KeyBind) }
            };
            ...
            {
                Label = { Text = string.Format(CEnvir.Language.UseNetworkConfig) },
                Parent = NetworkTab,
                Checked = Config.FullScreen,
            };
            ...
            label = new DXLabel
            {
                Text = string.Format(CEnvir.Language.IPAddress),
                Outline = true,
                Parent = NetworkTab,
            };
            label.Location = new Point(104 - label.Size.Width, 35);
            ...
            label = new DXLabel
            {
                Text = string.Format(CEnvir.Language.Port),
                Outline = true,
                Parent = NetworkTab,
            };
            label.Location = new Point(104 - label.Size.Width, 60);
            ...
            label = new DXLabel
            {
                Text = string.Format(CEnvir.Language.LocalChat),
                Outline = true,
                Parent = ColourTab,
            };
            ...
            label = new DXLabel
            {
                Text = string.Format(CEnvir.Language.GMWhisperIn),
                Outline = true,
                Parent = ColourTab,
            };
            ...
            label = new DXLabel
            {
                Text = string.Format(CEnvir.Language.WhisperIn),
                Outline = true,
                Parent = ColourTab,
            };
            ...
            label = new DXLabel
            {
                Text = string.Format(CEnvir.Language.WhisperOut),
                Outline = true,
                Parent = ColourTab,
            };
            ...
            label = new DXLabel
            {
                Text = string.Format(CEnvir.Language.GroupChat),
                Outline = true,
                Parent = ColourTab,
            };
            ...
            label = new DXLabel
            {
                Text = string.Format(CEnvir.Language.GuildChat),
                Outline = true,
                Parent = ColourTab,
            };
            ...
            label = new DXLabel
            {
                Text = string.Format(CEnvir.Language.ShoutChat),
                Outline = true,
                Parent = ColourTab,
            };
            ...
            label = new DXLabel
            {
                Text = string.Format(CEnvir.Language.GlobalChat),
                Outline = true,
                Parent = ColourTab,
            };
            ...
            label = new DXLabel
            {
                Text = string.Format(CEnvir.Language.ObserverChat),
                Outline = true,
                Parent = ColourTab,
            };
            ...
            label = new DXLabel
            {
                Text = string.Format(CEnvir.Language.HintText),
                Outline = true,
                Parent = ColourTab,
            };
            ...
            label = new DXLabel
            {
                Text = string.Format(CEnvir.Language.SystemText),
                Outline = true,
                Parent = ColourTab,
            };
            ...
            label = new DXLabel
            {
                Text = string.Format(CEnvir.Language.GainsText),
                Outline = true,
                Parent = ColourTab,
            };
            ...
            label = new DXLabel
            {
                Text = string.Format(CEnvir.Language.Announcements),
                Outline = true,
                Parent = ColourTab,
            };
            ...
            ResetColoursButton = new DXButton
            {
                ...
                Size = new Size(80, SmallButtonHeight),
                ButtonType = ButtonType.SmallButton,
                Label = { Text = string.Format(CEnvir.Language.ResetAll) }
            };
            ...
            SaveButton = new DXButton
            {
                ...
                Parent = this,
                Label = { Text = string.Format(CEnvir.Language.Apply) }
            };
            ...
            CancelButton = new DXButton
            {
                ...
                Size = new Size(80, DefaultHeight),
                Parent = this,
                Label = { Text = string.Format(CEnvir.Language.Cancel) }
            };
            ...
            ExitButton = new DXButton
            {
                ...
                Parent = this,
                Label = { Text = string.Format(CEnvir.Language.Exit), },
                Visible = false,
            };
